    ...
    return (
      <>
        {isLoading ? (
          ...
          <div className='text-center py-4 rounded-2xl acrylic-light text-stone-600 dark:text-stone-400'>
        ...
        {isExpanded && (
          ...
          >
            {isLoading ? (
              ...
              <div className='text-center py-4 text-stone-600 rounded-2xl acrylic-light dark:text-stone-400'>
                No research notes yet. Create notes by adding them to your conversations.
              </div>
            ) : (
              <div className='space-y-3'>
