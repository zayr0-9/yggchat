...
const ConversationPage: React.FC = () => {
  ...
  return (
    <div className='bg-zinc-50 dark:bg-zinc-900 flex overflow-hidden h-full'>
      ...
      <div className='relative z-10 flex-1 h-full flex flex-col overflow-hidden w-full mx-1 sm:mr-4 sm:ml-4 md:mr-8 md:ml-8 lg:mr-15 lg:ml-15 xl:mr-20 xl:ml-15 2xl:mr-25 2xl:ml-15 3xl:mr-35 3xl:ml-20 transition-all px-2 duration-300 pt-10'>
