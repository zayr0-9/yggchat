...
const BASE_URL = 'https://awvlmkkdnwmpgomsuneb.supabase.co/storage/v1/object/public/updates/updates'
                                ...
                                >
                                    ...
                                    <div className='flex-1 text-left'>
                                        <div className={`font-semibold ${platform.textColor} flex items-center gap-2`}>
                                            {platform.name}
                                            {info.version && (
                                                <span className='text-xs font-normal opacity-70'>v{info.version}</span>
                                            )}
                                        </div>
